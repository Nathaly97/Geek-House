...
registerForm.addEventListener('submit', (e) => {
    ...
    const residencia = document.querySelector('#direccion').value
    const city = document.querySelector('#ciudad').value
    const cel = document.querySelector('#tel').value
    ...
    Users.push({ name, Apellido, documento, residencia, city, cel, email, password })
